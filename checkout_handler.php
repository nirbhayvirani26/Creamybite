...
// A gift the customer was PROMISED in the basket — for EVERY order, not
// only a trade one. This sat inside the trade-user block by mistake, so a
// retail customer shown "On us" in their basket still had nothing on the
// order telling anyone to put it in the box.
