...
<div style="max-width:550px; margin:0 auto;" class="glass-panel">
    <h2 style="margin-top:0;">🍨 Creamy Bite Database Seeder</h2>
    <?php if ($error): ?>
        <p style="color:#ef4444; font-weight:700;">❌ Could not connect to database:</p>
    ...
    <?php else: ?>
        ...
        <div style="margin-top:20px; display:flex; gap:12px;">
            <a href="login.php" class="btn-primary">Go to Admin Login</a>
